...
package com.example.aiimages.fragments
...
import com.example.aiimages.MainViewModel
import com.example.aiimages.R
import com.example.aiimages.TrainImage
import com.example.aiimages.TransferLearningHelper
import com.example.aiimages.TransferLearningHelper.Companion.CLASS_FOUR
import com.example.aiimages.TransferLearningHelper.Companion.CLASS_ONE
import com.example.aiimages.TransferLearningHelper.Companion.CLASS_THREE
import com.example.aiimages.TransferLearningHelper.Companion.CLASS_TWO
import com.example.aiimages.databinding.FragmentCameraBinding
                    ...
                    sampleCollectionHandler.post(object : Runnable {
                        override fun run() {
                            ...
                            if (timePressed < LONG_PRESS_DURATION) {
                                Log.e("Sd12sd3232",timePressed.toString()+"");
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(fragmentCameraBinding) {
            ...
            llClassFour.setOnClickListener {
                val intent = Intent(activity, TrainImage::class.java)
...
//            llClassFour.setOnTouchListener(onAddSampleTouchListener)
            ...
            ImageAnalysis.Builder()
                ...
                .also {
                    it.setAnalyzer(cameraExecutor) { image ->
                        ...
                        if (sampleClass != null) {
                            Log.e("bindCameraUseCases",sampleClass);
    ...
    private fun addSample(image: ImageProxy, className: String) {
        ...
        val imageRotation = image.imageInfo.rotationDegrees
        Log.e("imageRotation:",imageRotation.toString())
        // Pass Bitmap and rotation to the transfer learning helper for
